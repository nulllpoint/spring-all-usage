...
FLOWABLE.URL = {
    ...
    getStencilSet: function() {
        ...
        // return FLOWABLE.CONFIG.contextRoot + '/replace/rest/stencil-sets/editor?version=' + Date.now();
        return FLOWABLE.CONFIG.contextRoot +'/' + window.REPLACE_URI['stencilSetForEditor_uri'] + Date.now();
    },
    
    getCmmnStencilSet: function() {
        // return FLOWABLE.CONFIG.contextRoot + '/app/rest/stencil-sets/cmmneditor?version=' + Date.now();
        return FLOWABLE.CONFIG.contextRoot + '/replace/rest/stencil-sets/cmmneditor?version=' + Date.now();
    },
