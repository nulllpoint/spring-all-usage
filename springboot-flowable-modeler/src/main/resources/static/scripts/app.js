...
flowableModeler
  ...
  .run(['$rootScope', '$timeout', '$modal', '$translate', '$location', '$http', '$window', 'appResourceRoot',
        function($rootScope, $timeout, $modal, $translate, $location, $http, $window, appResourceRoot) {
            ...
            $rootScope.switch_english = function () {
                $window.REPLACE_URI['stencilSetForEditor_uri'] = '/replace/rest/stencil-sets/editor?language=en&version=';
            };

            $rootScope.switch_chinese = function () {
                $window.REPLACE_URI['stencilSetForEditor_uri'] = '/replace/rest/stencil-sets/editor?language=zh&version=';
            };
        }
  ])
