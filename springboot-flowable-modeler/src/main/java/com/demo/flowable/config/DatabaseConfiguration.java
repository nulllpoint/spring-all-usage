...
///**
// * <p>
// *     flowable 依赖中集成了 原生mybatis , 即不支持springboot自动装配的版本
// *     如果想再集成springboot启动器版本类似mybatis-springboot-starter或mybatis-plus 启动器,
// *     1. 需要重写databaseconfiguration
// *          这是由于flowbale内部的mybatis会覆盖sqlTemplate和sqlsessionFactory
// *     2. 另外一种方法是在pom依赖中 排除其内部的mybatis的依赖
// * </p>
// * @author liuhoujie
// */
//@Configuration
